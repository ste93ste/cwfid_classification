...
function net = cnn_cwfid_init_6(varargin)
...
net.layers{end+1} = struct('name', 'convolution4',...
                           'type', 'conv', ...
                           'weights', {{f*randn(3,3,40,80, 'single'),zeros(1,80,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
...
net.layers{end+1} = struct('name', 'convolution6',...
                           'type', 'conv', ...
                           'weights', {{f*randn(1,1,120,3, 'single'), zeros(1,3,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
