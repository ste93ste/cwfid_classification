...
function net = cnn_cwfid_init_3(varargin)
...
net.layers{end+1} = struct('name', 'convolution1',...
                           'type', 'conv', ...
                           'weights', {{f*randn(3,3,3,10, 'single'), zeros(1, 10, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;    
...
net.layers{end+1} = struct('name', 'convolution2',...
                           'type', 'conv', ...
                           'weights', {{f*randn(3,3,10,30, 'single'), zeros(1, 30, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;     
...
net.layers{end+1} = struct('name', 'convolution3',...
                           'type', 'conv', ...
                           'weights', {{f*randn(3,3,30,60, 'single'), zeros(1, 60, 'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ; 
net.layers{end+1} = struct('name','relu3','type','relu');                         
net.layers{end+1} = struct('name', 'pooling3',...
                           'type', 'pool', ...
                           'method', 'max', ...
                           'pool', [2 2], ...
                           'stride', 2, ...
...
net.layers{end+1} = struct('name', 'convolution4',...
                           'type', 'conv', ...
                           'weights', {{f*randn(2,2,60,100, 'single'),zeros(1,100,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
net.layers{end+1} = struct('name','relu4','type','relu');                                            
net.layers{end+1} = struct('name', 'pooling4',...
                           'type', 'pool', ...
                           'method', 'max', ...
                           'pool', [2 2], ...
                           'stride', 2, ...
                           'pad', 0) ;
net.layers{end+1} = struct('name', 'convolution5',...
                           'type', 'conv', ...
                           'weights', {{f*randn(1,1,100,3, 'single'), zeros(1,3,'single')}}, ...
                           'stride', 1, ...
                           'pad', 0) ;
